        ...
        success: function(response) {
            ...
            if (response) {
                ...
                for (let i = 0; i < time_length; i++) {
                    ...
                    } else if (weather5 == "陰短暫陣雨或雷雨") {
                        setBackgroundImage('box5', weather5, './upload/陰短暫陣雨或雷雨.svg');
                    }else if(weather5 == "多雲短暫雨"){
                        setBackgroundImage('box5', weather5, './upload/多雲短暫雨.svg');
                    }else if(weather5 == "多雲短暫陣雨"){
                        setBackgroundImage('box5', weather5, './upload/多雲短暫陣雨.svg');
                    }
                    if (weather6 == "多雲時陰") {
                    ...
                    } else if (weather6 == "陰短暫陣雨或雷雨") {
                        setBackgroundImage('box6', weather6, './upload/陰短暫陣雨或雷雨.svg');
                    ...
                    } else if (weather7 == "多雲時陰短暫陣雨或雷雨") {
                        setBackgroundImage('box7', weather7, './upload/多雲時陰短暫陣雨或雷雨.svg');
                    }
                    if (weather8 == "多雲") {
                    ...
                    }else if(weather9 == "陰時多雲短暫陣雨"){
                        setBackgroundImage('box9', weather9, './upload/陰時多雲短暫陣雨.svg');
                    }else if(weather9 == "多雲時陰"){
                        setBackgroundImage('box9', weather9, './upload/多雲時陰.svg');
                    }
