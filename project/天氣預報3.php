        ...
        success: function(response) {
            ...
            if (response) {
                ...
                for (let i = 0; i < time_length; i++) {
                    ...
                    } else if (weather19 == "陰陣雨") {
                        setBackgroundImage('box19', weather19, './upload/陰陣雨.svg');
                    } else if (weather19 == "晴時多雲") {
                    ...
                    }else if(weather19 == "陰時多雲短暫陣雨"){
                        setBackgroundImage('box19', weather19, './upload/陰時多雲短暫陣雨.svg');
                    }
                    if (weather20 == "陰天") {
                    ...
                    } else if (weather20 == "陰短暫陣雨") {
                        setBackgroundImage('box20', weather20, './upload/陰短暫陣雨.svg');
                    }else if(weather20 == "陰短暫雨"){
                        setBackgroundImage('box20', weather20, './upload/陰短暫雨.svg');
                    }else if(weather20 == "陰時多雲短暫陣雨"){
                        setBackgroundImage('box20', weather20, './upload/陰時多雲短暫陣雨.svg');
                    }
                    if (weather21 == "晴時多雲") {
                    ...
                    } else if (weather21 == "陰短暫陣雨") {
                        setBackgroundImage('box21', weather21, './upload/陰短暫陣雨.svg');
                    } else if (weather21 == "陰時多雲") {
                    ...
                    } else if (weather21 == "多雲短暫陣雨或雷雨") {
                        setBackgroundImage('box21', weather21, './upload/多雲短暫陣雨或雷雨.svg');
                    } else if (weather21 == "多雲時陰") {
                        setBackgroundImage('box21', weather21, './upload/多雲時陰.svg');
                    }else if(weather21 == "陰時多雲短暫陣雨"){
                        setBackgroundImage('box21', weather21, './upload/陰時多雲短暫陣雨.svg');
                    }
                    if (weather22 == "晴時多雲") {
                    ...
                    } else if (weather22 == "陰天") {
                        setBackgroundImage('box22', weather22, './upload/陰天.svg');
                    } else if (weather22 == "多雲時陰") {
                    ...
                    }else if(weather22 == "陰陣雨"){
                        setBackgroundImage('box22', weather22, './upload/陰陣雨.svg');
                    }else if(weather22 == "陰時多雲短暫陣雨"){
                        setBackgroundImage('box22', weather22, './upload/陰時多雲短暫陣雨.svg');
                    }else if(weather22 == "多雲時晴"){
                        setBackgroundImage('box22', weather22, './upload/多雲時晴.svg');
                    }
